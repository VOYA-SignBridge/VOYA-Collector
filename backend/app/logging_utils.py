...
Example:
  [STORAGE][RAW][SUCCESS] local_path=/app/dataset/raw_videos/... provider=local+cloudinary duration_ms=1234
  [STORAGE][NPZ][SUCCESS] local_path=/app/dataset/features/... mirror_url=s3://bucket/... duration_ms=567
...
class StructuredLogger:
    ...
    def log_operation(
        ...
        Args:
            ...
            error_code: Optional error code (e.g., "CLOUDINARY_TIMEOUT", "INSUFFICIENT_SPACE")
