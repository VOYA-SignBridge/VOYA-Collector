...
/**
 * Trang "Tài khoản của tôi" — chấp thuận và tên đăng nhập.
 *
 * Trang này là mắt xích cuối của một chuỗi đã hoàn chỉnh ở mọi mắt khác: bảng
 * `signer_consents` có từ v3.4, cổng đồng thuận đọc nó, ba endpoint đã sống —
 ...
 * chữ, hứa một hệ quả mà cơ chế không làm, hoặc đổi tên xong mà thanh bên vẫn
 * giữ tên cũ.
 */
...
vi.mock('../../api/auth', () => ({ updateUsername: vi.fn() }));
