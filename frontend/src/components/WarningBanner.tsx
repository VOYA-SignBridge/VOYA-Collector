  ...
  return (
    <div className="fixed inset-0 z-[9997] flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-2xl border border-amber-200 p-8 text-center">
        ...
        <h2 className="text-xl font-bold text-slate-900 mb-2">{t("Thông báo từ quản trị viên")}</h2>
        ...
        <p className="text-xs text-slate-400 mb-5">
          {t("Vui lòng lưu ý nội dung trên để tiếp tục sử dụng dịch vụ một cách tốt nhất. Xin cảm ơn.")}
        </p>
        <button
          onClick={dismiss}
          disabled={busy}
