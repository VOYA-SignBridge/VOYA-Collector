    ...
    <section className="relative py-16 sm:py-24">
      ...
      <div className="text-center mb-12 sm:mb-16">
        ...
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 mb-6">
          CTU.SignBridge là gì?
        </h2>
        <p className="text-lg sm:text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
          Một hệ sinh thái mở, kết nối công nghệ AI và cộng đồng để xây dựng
          tài nguyên Ngôn ngữ Ký hiệu Việt Nam (VSL) đầu tiên tại Việt Nam.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
        ...
        <div className="group relative bg-white rounded-3xl p-8 sm:p-10 border border-slate-200/60 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
          ...
          <div className="relative">
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-3">Thu thập dữ liệu cộng đồng</h3>
            <p className="text-slate-600 leading-relaxed">
              Nền tảng cho phép người dùng đóng góp video ký hiệu dễ dàng thông qua webcam hoặc tải lên video có sẵn.
              Mỗi mẫu dữ liệu đều được gắn nhãn và xác thực tự động.
            </p>
          </div>
        </div>
        ...
        <div className="group relative bg-white rounded-3xl p-8 sm:p-10 border border-slate-200/60 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
          ...
          <div className="relative">
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-3">Nhận dạng bằng AI</h3>
            <p className="text-slate-600 leading-relaxed">
              Sử dụng mô hình Deep Learning (TCN) kết hợp MediaPipe để nhận dạng ký hiệu theo thời gian thực,
              hỗ trợ nhiều phương ngữ ký hiệu khác nhau.
            </p>
          </div>
        </div>
        ...
        <div className="group relative bg-white rounded-3xl p-8 sm:p-10 border border-slate-200/60 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
          ...
          <div className="relative">
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-3">Nghiên cứu & Mã nguồn mở</h3>
            <p className="text-slate-600 leading-relaxed">
              Dự án nghiên cứu khoa học tại Đại học Cần Thơ, hướng đến xây dựng
              bộ dữ liệu VSL chuẩn đầu tiên phục vụ cộng đồng và nghiên cứu.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-12 sm:mt-16 bg-gradient-to-r from-ctu-navy via-ctu-navy-mid to-ctu-blue rounded-3xl p-8 sm:p-12 text-white shadow-2xl shadow-ctu-navy/30">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div>
            ...
            <div className="text-sm sm:text-base text-white/70">Nhận dạng realtime</div>
          </div>
          <div>
            <div className="text-3xl sm:text-4xl font-bold mb-1">VSL</div>
            <div className="text-sm sm:text-base text-white/70">Ngôn ngữ ký hiệu VN</div>
          </div>
          <div>
            <div className="text-3xl sm:text-4xl font-bold mb-1">CTU</div>
            <div className="text-sm sm:text-base text-white/70">Đại học Cần Thơ</div>
          </div>
          <div>
            <div className="text-3xl sm:text-4xl font-bold mb-1">Open</div>
            <div className="text-sm sm:text-base text-white/70">Mã nguồn mở</div>
          </div>
        </div>
      </div>
    </section>
