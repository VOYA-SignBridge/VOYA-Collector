...
def build_manifest(features_root: Path, labels_rows: list, signer_name_to_id: dict) -> tuple:
    label_by_folder = {}
...
def main() -> int:
    ...
    rows, unreadable, unlabeled = build_manifest(args.features_root, labels_rows, signer_name_to_id)
