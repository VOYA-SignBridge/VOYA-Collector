...
| Việc | Tài liệu |
|---|---|
| Community Data Commons | [COMMUNITY_DATA_COMMONS.md](COMMUNITY_DATA_COMMONS.md) |
| Hệ thống consent | *(nằm trong tài liệu trên)* |
| Đổi tên bảng `community_*` → catalog | [REGISTRY_ARCHITECTURE.md](REGISTRY_ARCHITECTURE.md) §2 |
| Refresh token reuse detection | [AUTH_TOKEN_LIFECYCLE.md](AUTH_TOKEN_LIFECYCLE.md) |
| Lật `hands126_v2` | [KNOWN_ISSUES.md](../KNOWN_ISSUES.md) |
