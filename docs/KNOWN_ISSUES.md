...
Sổ tay đầy đủ cho B1–B4: [BACKUP_RESTORE.md](BACKUP_RESTORE.md).
Chi tiết B5: [OBSERVABILITY_PLAN.md](OBSERVABILITY_PLAN.md) §10.4.
...
> `docs/OBSERVABILITY_PLAN.md` §9bis.
...
| Việc | Chi tiết |
|---|---|
| **Đồng thuận được thực thi** | `app/consent_gate.py` + ảnh chụp + CLI, nối vào huấn luyện / manifest / LOSO. Xem `docs/CONSENT_ENFORCEMENT.md`. 43 test. |
...
Xem `docs/SUBSCRIPTION_LIFECYCLE.md`. Kỳ hạn, tự gia hạn, nhắc 7/3/1 ngày, ân
...
Bốn lỗ ở `docs/needFix/AUTH_TOKEN_LIFECYCLE.md` (rà 31/07) đã đóng, cộng bốn
tính năng của Mục 12. Chi tiết ở `docs/SESSION_LIFECYCLE.md`,
`docs/TWO_FACTOR.md`, `docs/NOTIFICATIONS_AND_SUPPORT.md`.
...
- **SSO** — thiết kế đầy đủ ở `docs/needFix/SSO_OIDC_DESIGN.md`, **chưa hiện
