...
```
1. SOẠN      docs/legal/terms-2026-09-01.md  (nhánh git, pull request)
...
python -m app.cli.register_legal_document \
    ...
    --file docs/legal/terms-2026-09-01.md \
    --url /legal/terms \
...
python -m app.cli.register_legal_document \
    ...
    --file docs/legal/privacy-2026-09-01.md \
    --url /legal/privacy \
...
> nghĩa của "thu hồi" ở `docs/needFix/COMMUNITY_DATA_COMMONS.md`, và cổng này
> chỉ thi hành nghĩa thứ hai. Chi tiết: `docs/CONSENT_ENFORCEMENT.md`.
